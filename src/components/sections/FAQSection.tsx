...
const FAQS = [
  ...
  },
  {
    ...
    a: "For multi-day programs and investor delegations, we recommend at least 6–8 weeks — curated meetings and premium logistics take time to get right. For shorter visits or concierge-only support, 2–4 weeks is usually sufficient. That said, reach out even if you're working to a tight timeline — we'll always do our best.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — we've built a trusted network of partners across accommodation, transport, dining, and institutional access. Key partners include KIC (Kumasi Innovation Centre), Pelican Hotel, Adonai, Scenic Restaurants, and several premium venues across Accra and beyond.",
  },
  {
    q: "What does the process look like once I reach out?",
    a: "We'll schedule a short discovery call to understand your objectives, timeline, and group profile. From there, we design a tailored program proposal — including a clear scope, itinerary outline, and investment summary. Most clients move from first call to confirmed program within two weeks.",
  },
  {
